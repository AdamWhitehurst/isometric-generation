...
namespace FauxGravity {
    ...
    public class KinematicBody : Body {
        ...
        public float jumpSpeedModifier = 0.1f;
        ...
        public bool HandleMoveForward() {
            ...
            if (horizontalInputs.y != 0) {
                Vector3 moveForce = horizontalInputs.y * Vector3.forward * Settings.CharacterSpeed;
        ...
        public IEnumerator JumpRoutine() {
            ...
            while (CanMoveUpward() && curJumpHeight <= Settings.CharacterJumpHeight) {
        ...
        public override void AddGravityForce(Vector3 gravity) {
            ...
            if (!IsGrounded()) transform.Translate(-Vector3.up * gravity.magnitude * Time.fixedDeltaTime);
        ...
        public override bool IsGrounded() {
            ...
            if (Physics.SphereCast(col.bounds.center, sphereCastRadius, -transform.up, out hit, maxCastDistance, LayerMask.GetMask("World"))) {
                Debug.DrawRay(transform.position, -transform.up * 0.5f, Color.red, 0.001f);
                return true;
            }
